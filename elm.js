...
var _ivanmauricio$elm_starter$Model$Model = F2(
	function (a, b) {
		return {threadIds: a, currentThread: b};
	});
var _ivanmauricio$elm_starter$Model$Post = F4(
	function (a, b, c, d) {
		return {subject: a, body: b, postId: c, date: d};
	});
var _ivanmauricio$elm_starter$Model$ReceivePosts = function (a) {
	return {ctor: 'ReceivePosts', _0: a};
};

var _ivanmauricio$elm_starter$Request$postDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'subject',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_ivanmauricio$elm_starter$Model$Post)))));
var _ivanmauricio$elm_starter$Request$payloadDecoder = A2(
	...
	_elm_lang$core$Json_Decode$list(
		A2(_elm_lang$core$Json_Decode$field, '_source', _ivanmauricio$elm_starter$Request$postDecoder)));
var _ivanmauricio$elm_starter$Request$postBody = _elm_lang$core$Json_Encode$object(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
						...
						_1: _elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									...
									_1: _elm_lang$core$Json_Encode$list(
										{
											ctor: '::',
											_0: _elm_lang$core$Json_Encode$int(5804),
											_1: {
												ctor: '::',
												_0: _elm_lang$core$Json_Encode$int(5882),
												_1: {
													ctor: '::',
													_0: _elm_lang$core$Json_Encode$int(8995),
													_1: {ctor: '[]'}
												}
											}
										})
							...
							_1: _elm_lang$core$Json_Encode$object(
								{
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'order',
										_1: _elm_lang$core$Json_Encode$string('desc')
									},
									_1: {ctor: '[]'}
								})
						},
...
var _ivanmauricio$elm_starter$Request$postRequest = A3(
	_elm_lang$http$Http$post,
	'http://localhost:9200/forum/_search?size=250',
	_elm_lang$http$Http$jsonBody(_ivanmauricio$elm_starter$Request$postBody),
	_ivanmauricio$elm_starter$Request$payloadDecoder);

var _ivanmauricio$elm_starter$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0._0.ctor === 'Ok') {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{currentThread: _p0._0._0}),
				{ctor: '[]'});
		} else {
			var log = A2(_elm_lang$core$Debug$log, 'error', _p0._0._0);
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				{ctor: '[]'});
...
var _ivanmauricio$elm_starter$Update$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		threadIds: {ctor: '[]'},
		currentThread: {ctor: '[]'}
	...
	{
		ctor: '::',
		_0: A2(_elm_lang$http$Http$send, _ivanmauricio$elm_starter$Model$ReceivePosts, _ivanmauricio$elm_starter$Request$postRequest),
		_1: {ctor: '[]'}
	});

var _ivanmauricio$elm_starter$View$view = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('sans-serif blue'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _ivanmauricio$elm_starter$Main$main = _elm_lang$html$Html$program(
	{
		update: _ivanmauricio$elm_starter$Update$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
		view: _ivanmauricio$elm_starter$View$view,
		init: _ivanmauricio$elm_starter$Update$init
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ivanmauricio$elm_starter$Main$main !== 'undefined') {
    _ivanmauricio$elm_starter$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Model.Msg":{"args":[],"tags":{"ReceivePosts":["Result.Result Http.Error (List Model.Post)"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Date.Date":{"args":[],"tags":{"Date":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Model.Post":{"args":[],"type":"{ subject : String, body : String, postId : Int, date : Date.Date }"}},"message":"Model.Msg"},"versions":{"elm":"0.18.0"}});
}
